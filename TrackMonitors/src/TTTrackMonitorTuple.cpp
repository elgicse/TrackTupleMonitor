...
DECLARE_ALGORITHM_FACTORY( TTTrackMonitorTuple )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
TTTrackMonitorTuple::TTTrackMonitorTuple(const std::string& name,
...
// Destructor
//=============================================================================
TTTrackMonitorTuple::~TTTrackMonitorTuple() {}

StatusCode TTTrackMonitorTuple::initialize()
{
...
// Execute
//=============================================================================
StatusCode TTTrackMonitorTuple::execute()
{
  // Book Tuple
  Tuples::Tuple tuple = GaudiTupleAlg::nTuple("TTTrackMonitorTuple",   "TTTrackMonitorTuple",   CLID_ColumnWiseTuple );
  ...
  std::vector<unsigned int> usedIDs; usedIDs.reserve(nClusters);
  ...
  BOOST_FOREACH( const LHCb::Track* track, tracks) 
    if( track->hasTT()) {
      ...
      tuple->farray("stIDs", usedIDs.begin(), usedIDs.end(), "len", nClusters);
    }
  ...
  tuple->farray("UniqueStIDs", usedIDs.begin(), usedIDs.end(), "len", nClusters);
...
void TTTrackMonitorTuple::fillHistograms(const LHCb::Track& track, 
...
unsigned int TTTrackMonitorTuple::histoBin(const LHCb::STChannelID& chan) const {
...
// Projected angle
double TTTrackMonitorTuple::ProjectedAngle() const {
