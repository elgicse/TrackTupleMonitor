...
from Configurables import STClusterCollector, STSelectChannelIDByElement, STTrackTuple

itEffTuple = STTrackTuple( "ITHitEfficiencyTuple" )
...
ttEffTuple = STTrackTuple( "TTHitEfficiencyTuple" )
