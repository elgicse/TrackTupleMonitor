...
RecSysConf().RecoSequence = ["Decoding", "VELO", "Tr", "Vertex"]
...
dataset = opts.get('dataset','uniform')
rndMisNum = opts.get('rndMisNum',0)
...
localDb= CondDBAccessSvc("myCondLocal",
                         ConnectionString="sqlite_file:../../{0}.db/SIMCOND".format(misSet),
...
def redefinefilters() :
    ...
    if isBeamGas: GaudiSequencer("HltFilterSeq").Members.append( odinFiltNonBB ) # Comment in MC because I have not reconstructed info on which beam is
...
dataName = 'beamgasMC' if isBeamGas else 'D02KPiMC'
...
if dataset == 'uniform': # here I have also a bit of Beamgas for having tracks near beam
    fileList_uniform = ['BeamgasMC_H1_2011_0.dst', 'BeamgasMC_H1_2011_1.dst', 'BeamgasMC_H1_2011_2.dst', 'BeamgasMC_H1_2011_3.dst', 'BeamgasMC_H1_2011_4.dst', 'BeamgasMC_H1_2011_5.dst', 'BeamgasMC_H1_2011_6.dst', 'BeamgasMC_H2_2011_0.dst', 'BeamgasMC_H2_2011_1.dst', 'BeamgasMC_H2_2011_2.dst', 'BeamgasMC_H2_2011_3.dst', 'BeamgasMC_H2_2011_4.dst', 'BeamgasMC_O1_2011_0.dst', 'BeamgasMC_O1_2011_1.dst', 'BeamgasMC_O1_2011_2.dst', 'BeamgasMC_O1_2011_3.dst', 'BeamgasMC_O1_2011_4.dst', 'BeamgasMC_O1_2011_5.dst', 'BeamgasMC_O1_2011_6.dst', 'BeamgasMC_O1_2011_7.dst', 'BeamgasMC_O1_2011_8.dst', 'BeamgasMC_O1_2011_9.dst', 'BeamgasMC_O2_2011_0.dst', 'BeamgasMC_O2_2011_1.dst', 'BeamgasMC_O2_2011_2.dst', 'BeamgasMC_O2_2011_3.dst']
    fileList = ['PFN:root://eoslhcb.cern.ch//eos/lhcb/user/g/gdujany/Alignment/alignMC/2011/Uniform/'+file for file in fileList_uniform]
    fileList_beamgas = ['BeamgasMC_H1_2011-500ev.dst','BeamgasMC_H2_2011-500ev.dst','BeamgasMC_O1_2011-500ev.dst','BeamgasMC_O2_2011-500ev.dst']
    fileList += ['PFN:root://eoslhcb.cern.ch//eos/lhcb/user/g/gdujany/Alignment/alignMC/2011/'+file for file in fileList_beamgas]
    IOHelper().inputFiles(fileList, clear=True)


if dataset == 'onlyUniform':
    fileList = ['BeamgasMC_H1_2011_0.dst', 'BeamgasMC_H1_2011_1.dst', 'BeamgasMC_H1_2011_2.dst', 'BeamgasMC_H1_2011_3.dst', 'BeamgasMC_H1_2011_4.dst', 'BeamgasMC_H1_2011_5.dst', 'BeamgasMC_H1_2011_6.dst', 'BeamgasMC_H2_2011_0.dst', 'BeamgasMC_H2_2011_1.dst', 'BeamgasMC_H2_2011_2.dst', 'BeamgasMC_H2_2011_3.dst', 'BeamgasMC_H2_2011_4.dst', 'BeamgasMC_O1_2011_0.dst', 'BeamgasMC_O1_2011_1.dst', 'BeamgasMC_O1_2011_2.dst', 'BeamgasMC_O1_2011_3.dst', 'BeamgasMC_O1_2011_4.dst', 'BeamgasMC_O1_2011_5.dst', 'BeamgasMC_O1_2011_6.dst', 'BeamgasMC_O1_2011_7.dst', 'BeamgasMC_O1_2011_8.dst', 'BeamgasMC_O1_2011_9.dst', 'BeamgasMC_O2_2011_0.dst', 'BeamgasMC_O2_2011_1.dst', 'BeamgasMC_O2_2011_2.dst', 'BeamgasMC_O2_2011_3.dst']
    IOHelper().inputFiles(['PFN:root://eoslhcb.cern.ch//eos/lhcb/user/g/gdujany/Alignment/alignMC/2011/Uniform/'+file for file in fileList], clear=True)


if dataset == 'beamgas':
    fileList = ['BeamgasMC_H1_2011-5kev.dst', 'BeamgasMC_H2_2011-5kev.dst', 'BeamgasMC_O1_2011-5kev.dst', 'BeamgasMC_O2_2011-5kev.dst']
    IOHelper().inputFiles(['PFN:root://eoslhcb.cern.ch//eos/lhcb/user/g/gdujany/Alignment/alignMC/2011/'+file for file in fileList], clear=True)
