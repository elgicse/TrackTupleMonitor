...
for ds in datasets2:
    ...
    j.name = "TrackTuple_begin2012_hitsOnTrack"
    ...
    jobtree.mkdir('STMonitoring/TrackTuple/2012Data/HitsOnTrack')
    jobtree.add(j, 'STMonitoring/TrackTuple/2012Data/HitsOnTrack')
    queues.add(j.submit)
    print 'fatto'
